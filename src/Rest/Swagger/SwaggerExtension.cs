...
public static class SwaggerExtension
{
    public static void AddSwagger(this IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Stackblob Rest Api", Version = "v1" });
    ...
    private static void AddSwaggerDocumentation(this SwaggerGenOptions c)
    {
        var xmlFilenames = AppDomain.CurrentDomain.GetAssemblies()
                                                  .Where(t => t.FullName.StartsWith("stackblob"))
    ...
    {
        c.AddSecurityDefinition("xpertSecurity", new OpenApiSecurityScheme()
        {
